...
import { addDoc, doc, serverTimestamp, updateDoc, collection } from "firebase/firestore";
...
const Modal = () => {
  ...
  const uploadPost = async () => {
    ...
    // Then get the post ID for the new post
                ...
                <div>
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <input
                        type="text"
                        className="border-none focus:ring-white focus:ring-0 w-full text-center"
                        ref={captionRef}
